...
begin
  ...
  try
    ...
    FFile.Size := FFile.GridFSFile.ChunkSize; //This code make test fail when doing write on the C library not sure why, changing to FFile.GridFSFile.ChunkSize + 1 doesn't blow up
    CheckEquals(11, FFile.Write(HELLO[1], Length(HELLO)));
    try
